...
## 2. 写进 `docs/01-requirements/README.md`
...
- `docs/rules/doc-sync-rules.md`: 规定发票状态流转规则变化时，必须同步更新 design、tdd 和 tasks

## 快速判断口诀

- 带“业务目标、用户收益”的句子，通常属于 intake 或 requirements
- 带“模块、接口、数据结构、技术方案”的句子，通常属于 design
- 带“先做什么、后做什么、分几期”的句子，通常属于 implementation plan
- 带“如何验证、哪些测试”的句子，通常属于 TDD plan
